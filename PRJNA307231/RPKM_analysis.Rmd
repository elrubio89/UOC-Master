...
select(aro_index,`Model Sequence ID`, `AMR Gene Family`,`Drug Class`, `Resistance Mechanism`,`Protein Accession`,`ARO Number` ), by.x = "ARO Accession", by.y="ARO Number")
return(x)}
```
...
x<-merge(x, select(aro_index,`Model Sequence ID`, `AMR Gene Family`,`Drug Class`, `Resistance Mechanism`, `ARO Accession`,`Protein Accession`) , by="ARO Accession", all.x=TRUE)
return(x)}
```
...
```{r}
box_RGI<-p1_RGI+geom_abline(slope = 0, intercept = cp_RGI$optimal_cutpoint, color = "red", linetype = "dotted")+
  scale_y_continuous(trans='log10')
box_Ariba<-p1_Ariba+geom_abline(slope = 0, intercept = cp_ariba$optimal_cutpoint, color = "red", linetype = "dotted")+  scale_y_continuous(trans='log10')
box_Groot<-p1_Groot+geom_abline(slope = 0, intercept = cp_groot$optimal_cutpoint, color = "red", linetype = "dotted")+  scale_y_continuous(trans='log10')
